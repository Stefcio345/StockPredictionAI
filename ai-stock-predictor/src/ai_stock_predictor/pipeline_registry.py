...
def register_pipelines() -> dict[str, Pipeline]:
    return {
        ...
        "__default__": download_data_pipeline.create_pipeline() + data_cleaning_pipeline.create_pipeline() + data_merge_pipeline.create_pipeline() + feature_engineering_pipeline.create_pipeline() # + m_pipeline.create_pipeline()
    }